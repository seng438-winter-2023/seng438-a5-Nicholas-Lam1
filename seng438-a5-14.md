...
Introduction - Shahdad

Model Ranking - Shahdad / Nick

Assessment using reliability growth testing - Shahdad / Nick

Assessment using reliability demonostration chart - Shahdad / Jargon
...
One of the encountered issues, was to find the best method to run Laplace Trend Test. As a result, having more details about it in the lab instructions will be helpful.
